...
Every call returns termux_api_result(result, error).
...
location(provider="gps", request="once")
...
microphone_record(
    ...
    encoder=None, bitrate=None, sample_rate=None, channel_count=None,
    default=False,
)
microphone_record_info()
microphone_record_quit()
share(file, action=None, content_type=None, share_to_default_receiver=False, title=None)
    # None -> use default
telephony_call(number)
telephony_cellinfo()
telephony_deviceinfo()
toast(s, short=False, position=None, text_color=None, background_color=None)
...
# default is device specific: https://stackoverflow.com/questions/5144713/
...
if __name__ == "__main__":
    ...
    # # microphone_record(file=None, limit=None,
    # #     encoder=None, bitrate=None, sample_rate=None, channel_count=None, default=False)
    ...
    print(
        '\ntoast("hello", short, position="bottom", text_color="black", background_color="white"):'
    )
    print(
        toast(
            "hello",
